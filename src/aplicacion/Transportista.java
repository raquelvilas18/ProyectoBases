...
public class Transportista extends Empleado{
   ...
   public Transportista(String usuario, String nombre, String dni, String correo, String telefono, String sexo, String direccion, int nomina, String anoIngreso, int numPaquetes,int capacidadrestante){
